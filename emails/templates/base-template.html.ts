          ...
          <tr>
            <td align="center" style="padding:32px 32px 20px 32px; font-size:9px; color:#6b7280; background-color:#f9f9f9;">
              ...
              <p style="margin:0 0 10px 0; text-align:left;">
                ...
                }/legal/privacy-policy" style="color:#6D5DE6; font-weight:600;">politique de confidentialité</a>.
              </p>
              <p style="margin:0 0 10px 0; text-align:left;">
                <strong>Conditions d'utilisation :</strong> L'utilisation de cette page de réponse à invitation implique l'acceptation de nos <a href="${
                  process.env.NEXT_PUBLIC_APP_URL ||
                  "https://teamify.onlinemichel.dev"
                }/legal/terms-of-use" style="color:#6D5DE6; font-weight:600;">conditions générales d'utilisation</a>, disponibles sur notre site web.
              </p>
                ...
                <a href="${
                  process.env.NEXT_PUBLIC_APP_URL ||
                  "https://teamify.onlinemichel.dev"
                }/legal/legal-notice" style="color:#6D5DE6; font-weight:600;">mentions légales</a> 
                et notre 
                <a href="${
                  process.env.NEXT_PUBLIC_APP_URL ||
                  "https://teamify.onlinemichel.dev"
