    ...
    <section className="relative min-h-[80vh] flex items-center justify-center w-full pt-2">
      <div className="relative z-10 w-full max-w-4xl mx-auto px-3 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          >
            La plateforme tout-en-un pour organiser vos événements, collaborer avec vos équipes 
            et communiquer en temps réel. Simplifiez votre gestion d'événements avec des outils 
          ...
          >
            <Link href="/auth/register" className="w-full sm:w-auto">
              <Button
                className="bg-[#7C3AED] text-white px-6 py-4 sm:px-8 sm:py-6 text-base sm:text-lg font-semibold flex items-center justify-center gap-3 h-12 sm:h-14 rounded-full w-full cursor-pointer"
              >
                <span className="flex items-center gap-2 sm:gap-3">
                  ...
                  <span className="sm:hidden">Continuer avec Google</span>
                </span>
              </Button>
            </Link>
          ...
          >
            ...
            >
              ...
              <span className="hidden sm:inline">Application 100% gratuite</span>
