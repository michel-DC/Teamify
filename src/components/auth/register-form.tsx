        ...
        <div className="flex flex-col lg:flex-row items-center gap-8">
          <div className="hidden lg:flex flex-1 items-center justify-center">
            <div className="w-full max-w-xl">
              <Image
                src="/images/illustration/register-page.svg"
                alt="Illustration d'inscription - Personne créant un compte"
                width={680}
                height={680}
            ...
            <div className="mt-6 sm:mt-8 bg-card/80 backdrop-blur-sm border border-border/60 rounded-2xl shadow-xl p-6 sm:p-8">
              ...
              <form onSubmit={handleSubmit} className="mt-6 space-y-4 sm:space-y-5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="confirmpassword" className="text-sm sm:text-base">Confirmez votre mot de passe</Label>
                    <div className="relative">
                      <Input
                        id="confirmpassword"
