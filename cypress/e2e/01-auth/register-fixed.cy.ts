// Test d'inscription utilisateur avec les bons sélecteurs
describe("Inscription utilisateur - Version corrigée", () => {
  beforeEach(() => {
  ...
  it("devrait afficher une erreur pour un email déjà utilisé", () => {
    // Créer un utilisateur existant d'abord
    ...
    cy.contains("Cette adresse email est déjà utilisée").should("be.visible");
  });
  ...
  it("devrait permettre l'inscription avec un code d'invitation", () => {
    ...
    cy.createOrganization({
      ...
      cy.request("POST", "/api/organizations/invite", {
        ...
        // Visiter la page d'inscription avec le code d'invitation
  ...
  it("devrait permettre de basculer la visibilité de la confirmation du mot de passe", () => {
    ...
    // Cliquer sur l'icône d'œil pour afficher la confirmation
